...
var SimpleCore = {
  ...
  changeReadModel: function () {
    ...
    if (SimpleCore.getLocalData('read-mode') == 'night') {
      ...
      $('.cover-img').css({
        'background': "url('https://cdn.jsdelivr.net/gh/honjun/ImageHosting/sina/006bYVyvgy1ftan88wcjrj30b50rudgx.jpg')",
        'background-image': 'https://cdn.jsdelivr.net/gh/honjun/ImageHosting/sina/006bYVyvgy1ftan88wcjrj30b50rudgx.jpg',
      ...
      $('.cover-img').css({
        'background': "url('https://cdn.jsdelivr.net/gh/honjun/ImageHosting/sina/006bYVyvgy1ftan83yt2ij30c30u9jtr.jpg')",
        'background-image': 'https://cdn.jsdelivr.net/gh/honjun/ImageHosting/sina/006bYVyvgy1ftan83yt2ij30c30u9jtr.jpg',
        'background-size': 'cover',
        'background-position': 'center',
        'background-repeat': 'no-repeat'
      })
